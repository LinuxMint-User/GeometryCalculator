...
The Android project generated by Tauri uses Gradle 8.14.3 by default, which **only supports up to Java 24**. If your JDK is 25 or newer (e.g. recent Fedora releases only ship 25/26), you must upgrade to Gradle 9.5.1 and adapt four generated files:
