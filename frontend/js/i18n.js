...
const zh = {
  ...
  domain: '取值范围',
  domainReals: '实数 ℝ',
  domainPositive: '正实数 (0, +∞)',
  domainNonnegative: '非负实数 [0, +∞)',
  domainNegative: '负实数 (-∞, 0)',
  domainNonpositive: '非正实数 (-∞, 0]',
  domainNonzero: '非零实数 (-∞,0)∪(0,+∞)',
  addBtn: '添加',
  addPointTitle: '点',
  pointName: '名称',
  pointNamePh: '单个大写字母',
  pointHint: '横/纵坐标与所在直线，恰好填 2 项',
  xCoord: 'x',
  yCoord: 'y',
  xCoordPh: '表达式 / 输入 x 设未知数',
  yCoordPh: '表达式 / 输入 y 设未知数',
  line1: '直线 1',
  line2: '直线 2',
  linePh: '如 AB',
  addCondTitle: '条件',
...
const en = {
  ...
  domain: 'Domain',
  domainReals: 'Real numbers ℝ',
  domainPositive: 'Positive (0, +∞)',
  domainNonnegative: 'Non-negative [0, +∞)',
  domainNegative: 'Negative (-∞, 0)',
  domainNonpositive: 'Non-positive (-∞, 0]',
  domainNonzero: 'Non-zero (-∞,0)∪(0,+∞)',
  addBtn: 'Add',
  addPointTitle: 'Point',
  pointName: 'Name',
  pointNamePh: 'single uppercase letter',
  pointHint: 'Fill exactly 2 of: x, y, or two lines',
  xCoord: 'x',
  yCoord: 'y',
  xCoordPh: 'expression / x for unknown',
  yCoordPh: 'expression / y for unknown',
  line1: 'Line 1',
  line2: 'Line 2',
  linePh: 'e.g. AB',
