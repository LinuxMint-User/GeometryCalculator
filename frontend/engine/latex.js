...
import { isIntRat, isNegRat, isOneRat, isZeroRat } from './expr.js';
const GREEK = {
    alpha: '\\alpha',
    beta: '\\beta',
    gamma: '\\gamma',
...
export function symNameToLatex(name) {
...
function signedNeg(t) {
    return t.kind === 'mul' && isNegRat(t.coeff) ? 1 : 0;
}
/** 单项带符号打印：提取 mul 系数负号 */
function latexSignedTerm(t) {
...
/** 生成 ``$$ ... $$`` 包裹的展示 LaTeX */
export function latexDisplay(e) {
    return `$$ ${latex(e)} $$`;
}
export { isZeroRat };
